...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        times = findViewById(R.id.ib_times);
        divide = findViewById(R.id.ib_divide);
    ...
    public void onClick(View v){
        ...
        if(v.getId() == R.id.ib_add) {
            ...
            divide.setBackgroundColor(Color.LTGRAY);
        ...
        else if(v.getId() == R.id.ib_times){
            select = 3;
            add.setBackgroundColor(Color.LTGRAY);
            minus.setBackgroundColor(Color.LTGRAY);
            divide.setBackgroundColor(Color.LTGRAY);
            times.setBackgroundColor(Color.BLUE);
        }
        else if(v.getId() == R.id.ib_divide){
            select = 4;
            add.setBackgroundColor(Color.LTGRAY);
            minus.setBackgroundColor(Color.LTGRAY);
            divide.setBackgroundColor(Color.BLUE);
            times.setBackgroundColor(Color.LTGRAY);
        }
